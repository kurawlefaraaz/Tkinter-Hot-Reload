...
def minify(tokens,tab_option):
    ...
    result = dedent(result, use_tabs=tab_option)
    return result
print(minify(token_utils.listified_tokenizer(open(__file__).read()),1))